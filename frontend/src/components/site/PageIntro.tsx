...
export default function PageIntro({ number, eyebrow, title, description, image }: PageIntroProps) {
  return (
    <section className="relative overflow-hidden border-b border-white/10" data-testid="page-intro-section">
      {image && <img src={image} alt="ALS Royal Enfield Service workshop" className="absolute inset-0 h-full w-full object-cover opacity-25" data-testid="page-intro-background-image" />}
